                    ...
                    if(command == 1)
                    {
                        ...
                        switch(addressType)
                        {
                            ...
                            case 3:
                            {
                                ...
                                {
                                    // Domain length + 16 bit port number extends beyond the packet
                                    // payload length.
                                    return false;
                                }

                                // We don't need the domain name, but here it is anyway. std::string
                                // domainName(payload + 5, domainLength);
