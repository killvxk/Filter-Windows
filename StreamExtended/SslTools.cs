...
namespace StreamExtended
{
    public class SslTools
    {
        ...
        public static async Task<ClientHelloInfo> PeekClientHello(CustomBufferedStream clientStream)
        {
            ...
            // TODO: We need to implement a piece of code to recognize CONNECT and issue a proper response for it.
            ...
            else if (recordType == 67)
            {
                ...
                int length = clientStream.Read(buffer, 0, 256);
                ...
                System.Console.WriteLine("Builder: " + builder.ToString());
            }
